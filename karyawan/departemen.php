...
function rupiah($nilai, $pecahan = 0) {
 ...
 <div class="container-fluid" style="margin:50px 10px 50px 10px;">
       ...
       <form method="get">
         <div class="form-group">
           ...
           <select name="filter" onchange="form.submit()" class="form-control">
              ...
              <option value="CEO" <?php if($filter == 'CEO '){ echo 'selected'; } ?>>CEO</option>
              <option value="Manager" <?php if($filter == 'Manager'){ echo 'selected'; } ?>>Manager</option>
              <option value="Desainer" <?php if($filter == 'Desainer'){ echo 'selected'; } ?>>Desainer</option>
              <option value="Administrasi" <?php if($filter == 'Administrasi'){ echo 'selected'; } ?>>Administrasi</option>
              <option value="Inventory" <?php if($filter == 'Inventory'){ echo 'selected'; } ?>>Inventory</option>
              <option value="SDM" <?php if($filter == 'SDM'){ echo 'selected'; } ?>>SDM</option>
              <option value="Marketing dan Customer Service" <?php if($filter == 'Marketing dan Customer Service '){ echo 'selected'; } ?>>Marketing dan Customer Service</option>
           </select>
         </div>
       </form>
     </div>
   ...
   <div class="row" style="margin-top:50px;">
       <h4 class="text-center">Data Karyawan ShopAsiro</h4>
   </div>
